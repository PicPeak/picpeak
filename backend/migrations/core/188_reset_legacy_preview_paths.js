/**
 * Migration 188: drop preview keys written by the old generator.
 *
...
exports.up = async function(knex) {
  ...
  if (cleared) {
    console.log(`188_reset_legacy_preview_paths: cleared ${cleared} preview key(s); they regenerate on next view`);
  }
};
...
exports.down = async function() {
  console.log('188_reset_legacy_preview_paths: rollback is a no-op (preview keys are a regenerable cache)');
};
