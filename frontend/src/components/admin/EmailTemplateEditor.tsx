    ...
    <div className="border border-line-strong rounded-lg overflow-hidden">
          ...
          <div className="flex items-center gap-0.5 flex-wrap">
            {!isSourceMode && (
              <>
                ...
                <div className="w-px h-5 bg-fill-strong mx-1" />
          ...
          <div className="flex items-center gap-2">
            {variables.length > 0 && (
              <div className="relative">
                ...
                {showVariables && (
                  <div className="absolute right-0 top-full mt-1 z-10 bg-panel border border-line rounded-lg shadow-lg py-1 min-w-[200px] max-h-[240px] overflow-auto">
                    {variables.map(variable => (
                      <button
                        key={variable}
                        onClick={() => insertVariable(variable)}
                        className="w-full text-left px-3 py-1.5 text-sm hover:bg-hover transition-colors"
                        type="button"
                      >
      ...
      {isSourceMode ? (
        <textarea
          ...
          rows={15}
          className="w-full px-3 py-2 bg-shell text-heading font-mono text-sm focus:outline-none resize-y"
          spellCheck={false}
        />
      ) : (
        <EditorContent
