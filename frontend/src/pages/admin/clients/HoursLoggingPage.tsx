              ...
              {summary.map((r) => (
                ...
                >
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-heading truncate">{summaryLabel(r)}</span>
                      {r.isPassive && (
                        <span className="text-[10px] uppercase tracking-wider px-1.5 py-0.5 rounded bg-inset text-body">
