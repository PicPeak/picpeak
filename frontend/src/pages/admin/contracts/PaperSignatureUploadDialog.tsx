 ...
 * upload. With nobody left to confirm — everyone has already signed and this
 * is the counter-signed copy — the dialog is just a file picker.
 */
...
export const PaperSignatureUploadDialog: React.FC<PaperSignatureUploadDialogProps> = ({
  ...
  const canUpload = !!file && allTicked && !isUploading && !coverageQuery.isLoading;
